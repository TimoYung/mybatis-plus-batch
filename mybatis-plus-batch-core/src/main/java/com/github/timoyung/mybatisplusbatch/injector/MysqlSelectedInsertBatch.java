 ...
 * @since 1.0.0
 */
public class MysqlSelectedInsertBatch extends AbstractMethod {
    private static final String FOREACH_TPL = "<foreach collection=\"list\" item=\"item\" separator=\",\">\n %s \n </foreach>";
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        SqlMethod sqlMethod = SqlMethod.INSERT_BATCH_SELECTED;
